<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Pages</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('pages/edit/'.$pages->uuid);?>">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select name="sub_category" class="form-control <?= form_error('sub_category') ? 'invalid' : '' ?>" >
                                ...
                                foreach($sub_category as $val){ ?>
                                    <option value="<?= $val->uuid; ?>" <?= set_select('sub_category', $val->uuid) ;?> <?= $pages->sub_category==$val->uuid?'selected':'';?>><?= $val->sub_category; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="pages" class="form-control <?= form_error('pages') ? 'invalid' : '' ?> " placeholder="Masukkan Nama Departemen" value="<?= $pages->pages; ?>">
