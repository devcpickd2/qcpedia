<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Category</h1>
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('category/tambah');?>">
...
<!--                         <div class="col-sm-6">
                            ...
                            <select name="pages" class="form-control <?= form_error('pages') ? 'invalid' : '' ?>" >
                                ...
                                foreach($pages as $val){ ?>
                                    <option value="<?= $val->uuid; ?>" <?= set_select('pages', $val->uuid) ;?>><?= $val->pages; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="category" class="form-control <?= form_error('category') ? 'invalid' : '' ?> " placeholder="Masukkan Nama Category" value="<?= set_value('category'); ?>">
