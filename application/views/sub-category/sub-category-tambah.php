<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="post" action="<?= base_url('sub-category/tambah');?>">
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select name="category" class="form-control <?= form_error('category') ? 'invalid' : '' ?>" >
                                ...
                                foreach($category as $val){ ?>
                                    <option value="<?= $val->uuid; ?>" <?= set_select('category', $val->uuid) ;?>><?= $val->category; ?></option>
                                <?php } ?>
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="sub_category" class="form-control <?= form_error('sub_category') ? 'invalid' : '' ?> " placeholder="Masukkan Sub Category" value="<?= set_value('sub_category'); ?>">
